...
static const G4double toleranceNew = 0.1*CLHEP::keV; // Connor Bray (was: static const G4double tolerance = 0.1*CLHEP::keV; )
...
{
G4cout << "Using OLD Photon Evap." << G4endl; // Connor Bray
